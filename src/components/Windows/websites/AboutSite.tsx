    ...
    return (
        <div className="overview-page">
            ...
            <section className="stats-grid">
                ...
                <div className="stat-card">  LINES OF CODE
                    <h2>{length}+</h2>
                    <span>Resume Ready Projects</span>
                </div>
            ...
            <section className="about-card">
                ...
                <p>
                    I enjoy building polished desktop applications, websites,
                    Minecraft mods, and experimenting with cybersecurity and
