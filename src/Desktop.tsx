...
function Desktop() {
    ...
    // Preloads wallpapers to remove white flash
    useEffect(() => {
    ...
    const nextWallpaper = () => {
        setWallpaperId((prev) => (prev + 1) % wallpapers.length);
    };
        ...
        <div className="screen" style={{backgroundImage:`url(${wallpapers[wallpaperId]})`}}>
            ...
            <div  className={`desktop ${desktopHidden ? "desktop-hidden" : ""}`}>
                ...
                <div className="dock">
                    ...
                    <button className="icon open-vscode">
                    ...
                    <button className="icon open-terminal">
